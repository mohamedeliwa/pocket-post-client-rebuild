...
const resetPassword = () => {
  ...
  const handleResetRquestSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://pocket-post-server.herokuapp.com/password/reset", {
      method: "POST",
      headers: {
  ...
  const handleNewPasswordSubmit = async (e) => {
    ...
    const response = await fetch(
      `https://pocket-post-server.herokuapp.com/password/reset/${router.query.token}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
